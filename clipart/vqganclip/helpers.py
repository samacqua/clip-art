...
def download_pretrained_gan(dataset):
    ...
    print('downloading VQGan trained on ' + dataset + '...')
    ...
    # WikiArt 16384
    elif dataset == 'wikiart_16384':
        os.system("curl -L -o wikiart_16384.yaml -C - 'http://eaidata.bmk.sh/data/Wikiart_16384/wikiart_f16_16384_8145600.yaml'")
        os.system("curl -L -o wikiart_16384.ckpt -C - 'http://eaidata.bmk.sh/data/Wikiart_16384/wikiart_f16_16384_8145600.ckpt'")
